...
class MenuTurnosFinancieraPage extends StatefulWidget{

  @override
    State<StatefulWidget> createState () => new _MenuTurnosFinancieraPage();


   

}
class _MenuTurnosFinancieraPage extends State<MenuTurnosFinancieraPage>{
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Turnos Area Financiera",style: new TextStyle(
          fontFamily: 'FugazOne',
          fontSize: 23
        ),),
      ),
