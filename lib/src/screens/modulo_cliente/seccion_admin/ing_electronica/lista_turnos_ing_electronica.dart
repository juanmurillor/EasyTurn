...
class ListaTurnosIngElectronicaPage extends StatefulWidget {
  ListaTurnosIngElectronicaPage({this.auth, this.onSignedOut});
  final BaseAuth auth;
  final VoidCallback onSignedOut;
  @override
  State<StatefulWidget> createState() => new _ListaTurnosIngElectronicaPage();
}

class _ListaTurnosIngElectronicaPage extends State<ListaTurnosIngElectronicaPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      key: _scaffoldState,
      appBar: AppBar(
        title: Text("Turnos Ing Electronica",style: new TextStyle(
          fontFamily: 'FugazOne',
          fontSize: 23
        ),),
      ),
