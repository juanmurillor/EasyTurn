...
import 'package:easy_turn/src/screens/modulo_cliente/seccion_facultades/programas/menu_prog_ingSistemas.dart';
...
class MenuProgramasIngPage extends StatefulWidget{

  @override
    State<StatefulWidget> createState () => new _MenuProgramasIngPage();


   

}
class _MenuProgramasIngPage extends State<MenuProgramasIngPage>{
  ...
  void moveToMenuFacultadIngPage(){  
    Navigator.push(    
                context,
                MaterialPageRoute(builder: (context) => MenuIngSistemasPage()),
              );
  }
/*
